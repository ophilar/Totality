...
const api: Record<string, unknown> & { __taskListeners: Array<(state: unknown) => void>; __triggerTaskQueueUpdate: (state: unknown) => void } = {
  ...
  getMediaItems: (f: unknown) => invoke('db:getMediaItems', f),
  countMediaItems: (f: unknown) => invoke('db:countMediaItems', f),
  ...
  getTVShows: (f: unknown) => invoke('db:getTVShows', f),
  countTVShows: (f: unknown) => invoke('db:countTVShows', f),
