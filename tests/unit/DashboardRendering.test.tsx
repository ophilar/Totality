...
import { _registerWishlistHandlers } from '@main/ipc/wishlist'
import { _registerSourceHandlers } from '@main/ipc/sources'
import { _registerTaskQueueHandlers } from '@main/ipc/taskQueue'
