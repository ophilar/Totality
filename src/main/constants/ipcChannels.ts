...
export const IPC_CHANNELS = {
  ...
  DATABASE: {
    ...
    PLAYBACK_COMPATIBILITY_EVALUATE: 'db:playbackCompatibility:evaluate',
    ...
    SET_LIBRARY_ALLOW_EXPANDED_MATCHING: 'db:setLibraryAllowExpandedMatching',
    ...
    SEARCH_GLOBAL: 'db:search-global',
  },
  SOURCES: {
    LIST: 'sources:list',
    ADD: 'sources:add',
  ...
  MEDIA: {
    ...
    GET_OPTIMIZATION_ADVICE: 'media:getOptimizationAdvice',
  },
  TIMELINES: {
