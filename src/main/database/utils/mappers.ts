...
export function toSnakeCaseMediaItem(r: unknown, q?: unknown): MediaItem {
  ...
  return {
    ...
    tier_score: quality.tierScore !== undefined ? quality.tierScore : (quality.tier_score !== undefined ? quality.tier_score : (item.tierScore !== undefined ? item.tierScore : item.tier_score)),
    overall_score: quality.overallScore !== undefined ? quality.overallScore : quality.overall_score,
    ...
    evidence_status: quality.evidenceStatus !== undefined ? quality.evidenceStatus : quality.evidence_status,
    confidence: quality.confidence,
    savings_basis: quality.savingsBasis !== undefined ? quality.savingsBasis : quality.savings_basis,
...
export function toSnakeCaseQualityScore(r: unknown): QualityScore {
  ...
  return {
    ...
    tier_score: row.tierScore !== undefined ? row.tierScore as number | null : row.tier_score as number | null,
    bitrate_tier_score: row.bitrateTierScore !== undefined ? row.bitrateTierScore as number | null : row.bitrate_tier_score as number | null,
    audio_tier_score: row.audioTierScore !== undefined ? row.audioTierScore as number | null : row.audio_tier_score as number | null,
    overall_score: row.overallScore !== undefined ? row.overallScore as number | null : row.overall_score as number | null,
    resolution_score: row.resolutionScore !== undefined ? row.resolutionScore as number | null : row.resolution_score as number | null,
    bitrate_score: row.bitrateScore !== undefined ? row.bitrateScore as number | null : row.bitrate_score as number | null,
