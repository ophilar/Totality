...
export const optimizationApi = {
  optimizationDryRun: (title: string, sourceId: string, seriesIdentityKey: string, libraryId: string) =>
    ipcRenderer.invoke(IPC_CHANNELS.OPTIMIZATION.DRY_RUN, title, sourceId, seriesIdentityKey, libraryId),
