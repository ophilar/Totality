...
export const musicApi: MusicAPI = {
  ...
  musicGetArtists: (filters?: unknown) => ipcRenderer.invoke('music:artists:list', filters),
  ...
  musicGetAlbums: (filters?: unknown) => ipcRenderer.invoke('music:albums:list', filters),
  ...
  musicGetTracks: (filters?: unknown) => ipcRenderer.invoke('music:tracks:list', filters),
  ...
  musicCountArtists: (filters?: unknown) => ipcRenderer.invoke('music:artists:count', filters),
  musicCountAlbums: (filters?: unknown) => ipcRenderer.invoke('music:albums:count', filters),
  musicCountTracks: (filters?: unknown) => ipcRenderer.invoke('music:tracks:count', filters),
